---
layout: project
title: "ALeRCE: Clasificación automática de alertas astronómicas"
year: 2021
area: "Astroinformática"
summary: "Sistema para clasificar eventos astronómicos en tiempo real usando curvas de luz y modelos de aprendizaje de máquina."
authors:
  - "F. Förster"
  - "G. Cabrera-Vives"
  - "P. A. Estévez"
...
abstract: "ALeRCE es un broker de alertas astronómicas que recibe eventos de grandes levantamientos de cielo y ejecuta clasificación automática para apoyar seguimiento científico. El sistema integra ingeniería de datos, extracción de atributos de curvas de luz y modelos supervisados para priorizar candidatos relevantes en tiempo real."
...
links:
  - label: "Paper"
    url: "https://scholar.google.com/scholar?hl=es&q=The+automatic+learning+for+the+rapid+classification+of+events+ALeRCE"
